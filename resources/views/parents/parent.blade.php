    ...
    <div class="flex h-fit">
            ...
            <div class="container mx-auto pt-24 pb-8 px-4">
                ...
                <div class="flex flex-col md:flex-row justify-between mt-6">
                    ...
                    <a href="{{ route('parent.create') }}" class="inline-flex items-center px-4 py-2 mt-4 md:mt-0 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition duration-150 ease-in-out"><i class="fa-solid fa-user-plus m-1"></i>Add Parent</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <div class="flex items-center space-x-4">
                                        <a href="{{ route('parent.edit', $item->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                        <form action="{{ route('parent.delete', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
