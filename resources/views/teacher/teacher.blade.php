    ...
    <div class="flex h-screen">
            ...
            <div class="container mx-auto pt-24 pb-8 px-4">
                ...
                <div class="flex flex-col md:flex-row justify-between mt-6">
                    ...
                    <a href="{{ route('teacher.create') }}" class="inline-flex items-center px-4 py-2 mt-4 md:mt-0 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition duration-150 ease-in-out"><i class="fa-solid fa-user-plus m-1"></i>Add Teacher</a>
                </div>
                    ...
                    <table class="w-full bg-white shadow-md rounded-lg">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 bg-gradient-to-r from-gray-200 to-gray-100 text-xs font-semibold text-gray-700 uppercase tracking-wider">Position</th>
